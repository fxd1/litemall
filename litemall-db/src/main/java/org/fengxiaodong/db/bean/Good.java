...
public class Good {
    ...
    public enum Status{
        ...
        //0，提交 1.已付款未发货 2. 已经发货未付款 3.已经发货且已付款 4.取消, 5 删除
        SUBMIT((byte) 0, "提交"),
        PAY_NO_DELIVERY((byte)1, "已付款未发货"),
        DELIVERY_NO_PAY((byte)2, "已经发货未付款"),
        DELIVERY_PAY((byte) 3, "已经发货且已付款"),
        CACEL((byte)4, "取消"),
        DELETE((byte)5, "删除");
